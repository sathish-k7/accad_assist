...
from .routes import summarizer, questions, export
...
async def api_info():
    return {
        ...
        "features": {
            ...
            "export": {
                "description": "PDF export and document processing",
                "supported_formats": ["PDF", "DOCX", "TXT", "PPTX"],
                "capabilities": ["PDF generation", "Content analysis", "Academic formatting", "Report creation"],
                "ai_models": ["GPT-3.5", "GPT-4", "Claude-3", "Gemini Pro", "Mistral 7B"],
                "export_types": ["summary_export", "parse_export", "comprehensive_analysis"]
            }
        },
